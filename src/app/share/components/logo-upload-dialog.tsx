			...
			<form onSubmit={handleSubmit} className='space-y-4'>
				<div>
					...
					<div
						...
						className='mx-auto flex h-32 w-32 cursor-pointer items-center justify-center rounded-xl border border-gray-300 dark:border-gray-600 bg-secondary/10 transition-colors hover:bg-gray-200 dark:bg-gray-700'>
						{previewFile ? (
				...
				<div className='flex gap-3 pt-2'>
					...
					<button
						type='button'
						onClick={handleClose}
						className='flex-1 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-[#1c2629] px-6 py-2.5 transition-colors hover:bg-gray-50 dark:hover:bg-gray-800/60'>
						取消
					</button>
				</div>
			</form>
