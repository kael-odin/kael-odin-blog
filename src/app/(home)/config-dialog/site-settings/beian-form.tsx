	...
	return (
		<div className='space-y-2'>
			...
			<div className='grid grid-cols-2 gap-2'>
				<div>
					<label className='mb-1 block text-xs text-gray-600 dark:text-gray-300'>备案号</label>
					<input
						type='text'
				...
				<div>
					<label className='mb-1 block text-xs text-gray-600 dark:text-gray-300'>备案链接（可选）</label>
					<input
						type='url'
