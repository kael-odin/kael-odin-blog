	...
	return (
		<DialogModal open={open} onClose={onClose} className='card w-[720px] max-w-[90vw] rounded-2xl p-6'>
			...
			<div className='space-y-4'>
				...
				<div className='flex flex-wrap gap-2 rounded-lg bg-white/60 dark:bg-white/10 p-3 text-sm'>
				...
				<div className='max-h-[360px] space-y-2 overflow-y-auto rounded-xl bg-white/60 dark:bg-white/10 p-3'>
					{editableItems.map(item => (
						<div key={item.slug} className='flex flex-col gap-2 rounded-lg border bg-white/80 dark:bg-white/10 px-3 py-2 sm:flex-row sm:items-center sm:justify-between'>
